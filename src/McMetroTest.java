...
class McMetroTest {
    ...
    void testMaxPassengers2() {
        ...
        Building[] buildings = new Building[]{
                new Building(bid1, 10),
                new Building(bid2, 10),
                new Building(bid3, 10),
                new Building(bid4, 10),
                new Building(bid5, 10),
                new Building(bid6, 10)
        };

        Track[] tracks = new Track[]{
                new Track(new TrackID(1), bid1, bid2, 5, 3),
                new Track(new TrackID(2), bid1, bid4, 5, 4),
                new Track(new TrackID(3), bid2, bid4, 5, 2),
                new Track(new TrackID(4), bid2, bid3, 5, 1),
                new Track(new TrackID(5), bid4, bid3, 5, 4),
                new Track(new TrackID(6), bid4, bid5, 5, 2),
                new Track(new TrackID(7), bid3, bid6, 5, 3),
                new Track(new TrackID(8), bid5, bid6, 5, 2)
        };
    ...
    void testMaxPassengers10() {
        // start building has 0 occupants
        BuildingID bid1 = new BuildingID(1);
        BuildingID bid2 = new BuildingID(2);
        BuildingID bid3 = new BuildingID(3);
        BuildingID bid4 = new BuildingID(4);
    ...
    void testBestMetro4() {
        ...
        McMetro mcMetro = new McMetro(tracks, buildings);
        TrackID[] bms = mcMetro.bestMetroSystem();
        TrackID[] expected = new TrackID[] {tid2, tid3};
        Arrays.sort(bms);
    ...
    @Test
    void testBestMetro6() {
        // multiple tracks connect the same pair of buildings
        BuildingID bid1 = new BuildingID(1);
        BuildingID bid2 = new BuildingID(2);
        BuildingID bid3 = new BuildingID(3);
        BuildingID bid4 = new BuildingID(4);
    ...
    void testBestMetro8() {
        ...
        TrackID tid8 = new TrackID(8);
        Track[] tracks = new Track[]{
                new Track(tid1, bid1, bid2, 8, 5),
                new Track(tid2, bid1, bid4, 7, 5),
                new Track(tid3, bid2, bid4, 6, 5),
                new Track(tid4, bid2, bid3, 1, 5),
                new Track(tid5, bid4, bid3, 4, 5),
                new Track(tid6, bid4, bid5, 3, 5),
                new Track(tid7, bid3, bid6, 2, 5),
                new Track(tid8, bid5, bid6, 5, 5)
        };

        McMetro mcMetro = new McMetro(tracks, buildings);
        TrackID[] bms = mcMetro.bestMetroSystem();
        TrackID[] expected = new TrackID[]{tid4, tid7, tid5, tid8, tid2};
        Arrays.sort(bms);
        Arrays.sort(expected);
